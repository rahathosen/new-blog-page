        ...
        <div className="mx-auto max-w-7xl ">
          ...
          <section className="pt-8 grid gap-4 lg:grid-cols-4">
            <div className="violet lg:col-span-2">
              ...
              <div className="flex flex-wrap  gap-y-1 overflow-hidden text-sm leading-6 text-gray-900">
                <time className="mr-8">Mar 16, 2020</time>
                <div className="-ml-4 flex items-center gap-x-4">
                  <div className="inline-block h-3 border-l-2 border-red-600 "></div>
                  <div className="text-gray-900"> Europe</div>
                </div>
              </div>
            </div>
            <div className="gray">
            ...
            <div className="white-long lg:col-start-4 lg:row-span-2 lg:row-start-1">
